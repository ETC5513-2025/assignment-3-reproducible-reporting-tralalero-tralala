...
We investigate the relationship between the number of shots taken by English Premier League (EPL) teams and their season win rates. Using match data from the 2000/01 to 2024/25 seasons, the analysis focuses on 200 team-season observations from the most recent ten seasons. Results indicate a positive correlation between average shots per game and win rate, suggesting that teams with higher shot volume tend to perform better. So we recommend that teams consider increasing shot frequency to improve their chances of winning, while also emphasizing the importance of shot quality and tactical balance.

## Introduction

In recent years, the English Premier League (EPL) has witnessed notable shifts in tactical approaches, with many teams adopting more aggressive, attack-focused strategies. These changes are often reflected in match statistics, particularly in the number of shots taken per game—a commonly used proxy for offensive intent. Over the past two decades, the league has undergone significant stylistic evolution, with teams increasingly adopting more attack-oriented strategies. This shift is evident in the rising average number of shots taken per match, as illustrated in our research, suggesting a broader trend toward shots and win-rate.
